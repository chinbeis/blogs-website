...
const translations: Record<Language, Translations> = {
  mn: {
    ...
    // Hero Section
    'hero.title': 'Монголын зүрх, судсан дотуурх мэс заслын нийгэмлэг',
    'hero.subtitle': 'Монголын зүрх, судсан дотуурх мэс заслын нийгэмлэг нь дэвшилтэт судалгаа, боловсрол, эмнэлзүйн шилдэг ажиллагаагаар зүрхний судасны эрүүл мэндийг сайжруулахад зориулагдсан.',
    ...
    'footer.copyright': '© 2024 Монголын зүрх, судсан дотуурх мэс заслын нийгэмлэг. Бүх эрх хуулиар хамгаалагдсан.',
